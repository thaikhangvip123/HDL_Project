...
HD_PWD='E:/DoorLock/Project_HDL/Project_HDL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fsm_door_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fsm_door_lock.tcl -notrace
