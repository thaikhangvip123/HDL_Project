...
namespace eval ::optrace {
  variable script "E:/DoorLock/Project_HDL/Project_HDL.runs/impl_1/top_module.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet E:/DoorLock/Project_HDL/Project_HDL.runs/synth_1/top_module.dcp
